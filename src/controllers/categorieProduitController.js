const Categorie = require( "../models/categorieProduitModel");
const Produit = require( "../models/produitModel");
const DeletedCategorie = require( "../models/deletedCategorieProduit");
const DeletedProduit = require( "../models/deletedProduit");
